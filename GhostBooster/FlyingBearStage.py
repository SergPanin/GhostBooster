...
class FlyingBearStage(CuraStage): 
        ...
        if self._previously_active_view is not None:
            if self.jz_root is None:
                ...
                if self.jz_root:
                    ...
                    self.plugin_main.init_stage(self.plugin_ui_item,self.upload_file_name,self.upload_file_drive)
                    self.upload_file_name = None
                    self.upload_file_drive = None
                    self.jz_root.update()
    ...
    def setUploadFileNameSD(self, upload_file_name):
        self.upload_file_drive = "SD"
        self.upload_file_name = upload_file_name
        
        
    def setUploadFileNameUSB(self, upload_file_name):
